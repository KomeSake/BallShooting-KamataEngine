...
void Map::LoadNovice()
{
	...
	_mapValue2[1] = 47 * 128;
	_mapValue2[2] = 128;
	_mapValue2[3] = int(3 * 128 - 128.f / 2);
	_mapValue2[4] = int(28 * 128 - 128.f / 2);
	LoaclMapLoad("./Resources/Map/Map2.txt", _mapData2);
	_mapValue3[0] = 102 * 128;
	_mapValue3[1] = 41 * 128;
	_mapValue3[2] = 128;
	_mapValue3[3] = int(3 * 128 - 128.f / 2);
	_mapValue3[4] = int(16 * 128 - 128.f / 2);
	LoaclMapLoad("./Resources/Map/Map3.txt", _mapData3);
	_mapValue4[0] = 29 * 128;
	_mapValue4[1] = 28 * 128;
	_mapValue4[2] = 128;
	_mapValue4[3] = int(7 * 128 - 128.f / 2);
	_mapValue4[4] = int(8 * 128 - 128.f / 2);
